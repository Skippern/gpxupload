...
__NAME_RULES = dict({
    ...
    u'Moldova': Rule('tree', tree={4: True, {6: True, {8: True}}}),
    ...
    u'Romania': Rule(4: {6: True, 7: True}),
    ...
    u'The Netherlands': Rule('tree', tree={ u'Aruba': { 8: True }, u'Netherlands': { 4: { 8: True }} }),
    ...
    u'Senegal': Rule('tree', tree={3: {6: True}, {7: True, {8: True}}}),
    ...
    u'Tonga': Rule('treet', tree={3: {5: True, 7: True}, {4: True, 5: True}, }),
